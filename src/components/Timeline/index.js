    ...
    <Wrapper>
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            Meu primerio aplicativo open source, Animavita é um projeto para ajudar os animais a
            serem adotados e resgatados. Usa uma stack de tecnologias modernas e serviços como
            notificações push. Você pode ver todo meu trabalho acessando o repositório do Animavita
            no GitHub{' '}
            <ExternalLink
        ...
        >
          ...
          <p>
            ...
            resolvi realizar o sonho de palestrar. Foi então que em 30/10/2018 realizei minha
            primeira palestra pelo Dev.talks em Bauru sobre React Native, você pode acessar o link
            dos slides{' '}
            <ExternalLink
              aria-label="palestra"
              target="__blank"
        ...
        >
          ...
          <p>
            Meu primeiro emprego, atuando como desenvolvedor PHP com foco em laravel de uma
            plataforma de aprendizagem à distância, trabalhei com micro-serviços e tive meu primeiro
            contato com ReactJS.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            ...
            respostas do mundo de League of Legends, com um sistema de login via facebook para
            salvar os ranking.
          </p>
          <br />
          <ExternalLink
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">Unity</h4>
          <p>
            No último ano do CTI eu queria muito por meus conhecimentos à prova, então, decidi fazer
            o meu primeiro jogo. This Mig! (This must be a impossible game!) é um jogo de infinity
            fall em pixel art desenvolvido em C# com a plataforma Unity. E devo dizer que foi um
            jogo que fazia qualquer um ficar nervoso.
          </p>
          <br />
          <ExternalLink
            aria-label="This Mig!"
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">Bauru, São Paulo</h4>
          <p>
            Amigos eu achei que sabia programar, foi ai que eu descobri que eu ia tomar muito tapa
            na cara nessa vida. Comecei meus estudos no CTI em 2014, onde toda minha base de
            conhecimento foi construída e onde muitas amizades foram feitas, terminei o curso e me
            formei em 2016.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            Meu primeiro contato com o universo dos códigos, iniciei no mundo do desenvolvimento
            como criador de jogos usando RPG Maker XP e programando em RGSS.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
